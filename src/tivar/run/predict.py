...
def set_parser(parser):
  ...
  parser.add_argument("-o", type=str, dest="output", required=True, help="Output result file, default 0.05")
  parser.add_argument("--th", type=str, help="Output score threshold")
